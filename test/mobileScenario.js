...
const mobileScenario = [
  ...
  { emulateAction: { device: 'iPhone X' } },
  { setViewportAction: { width: 400, height: 900 } },
  ...
  { tapAction: { selector: 'input[type=radio][name=gender]' } },
  { tapAction: { selector: '#dob' } },
  { tapAction: { selector: 'body > div.datepicker.datepicker-dropdown.dropdown-menu.datepicker-orient-left.datepicker-orient-top > div.datepicker-days > table > tbody > tr:nth-child(1) > td:nth-child(1)' } },
  ...
  { tapAction: { selector: '.development-ways .checkbox:nth-child(1) input' } },
  { tapAction: { selector: '.development-ways .checkbox:nth-child(2) input' } },
  { tapAction: { selector: '.development-ways .checkbox:nth-child(3) input' } },
  { tapAction: { selector: '.development-ways .checkbox:nth-child(4) input' } },
  ...
  { takeScreenshotAction: { path: 'test/output/mobile.png', fullPage: true } },
  { closeAction: {} }
]
